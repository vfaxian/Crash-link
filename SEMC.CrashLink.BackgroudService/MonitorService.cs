...
namespace SEMC.CrashLink.BackgroudService
{
    class MonitorService
    {
        ...
        {
            FileOperator.DeleteOldFileByValidDeliverTime();
        }

        private void DeleteByMatchDate()
        {
            FileOperator.DeleteOldFileByMatchDate();
        }
        ...
        private bool OverFolderSize()
        {
             ...
             */
            double percent = FileOperator.getDiskFreeSize();
            string cmt = string.Format("The available disc space is {0:p}", percent);
